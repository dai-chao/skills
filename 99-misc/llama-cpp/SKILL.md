...
- **[hardware-requirements.md](references/hardware-requirements.md)** — VRAM sizing, platform-specific guidance (NVIDIA/Apple/CPU), Ollama memory math, cloud fallback options
